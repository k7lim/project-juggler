...
`pj` scans your agent session files on disk. No background process, no database, no indexing step.

**Filesystem store** (default): reads `.jsonl` session files from known locations:
